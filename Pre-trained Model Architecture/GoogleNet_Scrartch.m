clc; clear;
%Load Dataset
imdsTrain = imageDatastore("D:\Database\iHGS_Database\IMAGE_MHI_COMBINE_2","IncludeSubfolders",true,"LabelSource","foldernames");
...
tempLayers = [
    ...
    fullyConnectedLayer(100,"Name","loss3-classifier","BiasLearnRateFactor",2)
